...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"10px","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex","width":"100%","height":"auto"}'>
	  ...
	  <el-button v-if="isAuth('jiaoyuwenzhang','新增')" :style='{"cursor":"pointer","border":"0","padding":"0px 35px","margin":"0 10px 0 0","color":"#fff","minWidth":"90px","outline":"none","borderRadius":"0","background":"#20ad9e","width":"auto","fontSize":"14px","lineHeight":"42px","height":"42px"}' type="primary" @click="add('/index/jiaoyuwenzhangAdd')"><i v-if="true" :style='{"color":"#fff","margin":"0 10px 0 0","fontSize":"14px"}' class="el-icon-circle-plus-outline"></i>添加</el-button>
    </el-form>
	...
	<div class="list" :style='{"width":"100%","padding":"20px 7%","margin":"20px 0 10px","background":"none"}'>
		...
		<div class="list1 index-pv1" :style='{"padding":"0","margin":"30px 0 0","flexWrap":"wrap","background":"none","display":"flex","width":"100%","height":"auto"}'>
			<div :style='{"width":"30%","margin":"0 3% 20px 0","position":"relative","background":"none","height":"auto"}' v-for="(item, index) in dataList" :key="index" @click="toDetail(item)" class="list-item animation-box">
				<img :style='{"padding":"20px","margin":"0 0 12px","objectFit":"cover","background":"url(http://codegen.caihongy.cn/20230131/6afa6fc6db7b4b62bd4e8f4a24f3975e.png) no-repeat center top / 100% 100%","display":"block","width":"100%","height":"280px"}' v-if="item.wenzhangfengmian && item.wenzhangfengmian.substr(0,4)=='http'" :src="item.wenzhangfengmian" class="image" />
				<img :style='{"padding":"20px","margin":"0 0 12px","objectFit":"cover","background":"url(http://codegen.caihongy.cn/20230131/6afa6fc6db7b4b62bd4e8f4a24f3975e.png) no-repeat center top / 100% 100%","display":"block","width":"100%","height":"280px"}' v-else :src="baseUrl + (item.wenzhangfengmian?item.wenzhangfengmian.split(',')[0]:'')" class="image" />
				...
				<div :style='{"padding":"4px 0","margin":"0 auto 10px","whiteSpace":"nowrap","overflow":"hidden","color":"#333","textAlign":"center","background":"linear-gradient(0deg, rgba(238,177,238,1) 0%, rgba(165,228,222,1) 30%, rgba(165,228,222,1) 100%)","width":"90%","lineHeight":"30px","fontSize":"14px","textOverflow":"ellipsis"}' class="name ">{{item.wenzhangbiaoti}}</div>
			</div>
		</div>
	...
	<div class="hot" :style='{"width":"100%","padding":"150px 7% 40px","margin":"20px 0 0","background":"url(http://codegen.caihongy.cn/20230130/d81fd2d44f4e475eb1c571b1f64e5fae.png) no-repeat center top","height":"auto"}'>
	  ...
	  <div :style='{"padding":"10px 0","flexWrap":"wrap","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
	    <div v-for="item in hotList" :key="item" :style='{"width":"23%","margin":"0 0 20px","background":"#fff","height":"auto"}' @click="toDetail(item)">
	      <img :style='{"padding":"20px","margin":"0 0 10px","objectFit":"cover","background":"url(http://codegen.caihongy.cn/20230131/6afa6fc6db7b4b62bd4e8f4a24f3975e.png) no-repeat center top / 100% 100%","display":"block","width":"100%","height":"280px"}' :src="baseUrl + (item.wenzhangfengmian?item.wenzhangfengmian.split(',')[0]:'')" alt="">
	      <div :style='{"padding":"4px 0","margin":"0 auto 10px","whiteSpace":"nowrap","overflow":"hidden","color":"#333","textAlign":"center","background":"linear-gradient(0deg, rgba(238,177,238,1) 0%, rgba(165,228,222,1) 30%, rgba(165,228,222,1) 100%)","width":"90%","lineHeight":"30px","fontSize":"14px","textOverflow":"ellipsis"}'>{{item.wenzhangbiaoti}}</div>
  ...
  export default {
    ...
    methods: {
      ...
      getList(page, fenlei, ref = '') {
        ...
        this.$http.get('jiaoyuwenzhang/list', {params: Object.assign(params, searchWhere)}).then(res => {
          if (res.data.code == 0) {
      ...
      toDetail(item) {
        this.$router.push({path: '/index/jiaoyuwenzhangDetail', query: {detailObj: JSON.stringify(item)}});
      },
    }
  }
</script>
